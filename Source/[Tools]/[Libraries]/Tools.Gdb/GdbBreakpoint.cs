...
namespace Tools.Gdb
{
    ...
    public delegate void GdbBreakpointHitCallback(GdbClient gdbStub, GdbBreakpointHitData breakpointHitData);
    ...
    public class GdbBreakpointCollection : IEnumerable<GdbBreakpoint>
    {
        ...
        internal GdbBreakpointCollection(GdbClient gdbClient)
        {
        ...
        public void Add(GdbBreakpoint breakpoint)
        {
            ...
            switch (breakpoint.Type)
            {
                case GdbBreakpointType.Memory:
                    ...
                    response = gdbClient.Query(command);
                    break;
