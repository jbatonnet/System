...
namespace API
{
    ...
    public class Exception
    {
        ...
        public string Message
        {
            get
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x788FE2E3);
                    KernelStream.Write(pointer.ToInt32());
                    return KernelStream.ReadString();
                }
            }
        }
        public Collection<void> Frames
        {
            get
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x9687FC61);
                    KernelStream.Write(pointer.ToInt32());
                    return KernelStream.Read<Collection<void>>();
                }
            }
            set
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x9CA08D3A);
                    KernelStream.Write(pointer.ToInt32());
                    KernelStream.Write<Collection<void>>(value);
                }
            }
        }
    
        public Collection<void> GetFrames()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x4F019807);
                KernelStream.Write(pointer.ToInt32());
                return KernelStream.Read<Collection<void>>();
            }
        }
        public static void Assert()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x9D75FFD6);
            }
        }
    }
    ...
    public class LinkedList<T>
    {
        ...
        internal LinkedList(IntPtr pointer)
        {
            this.pointer = pointer;
        }
        ...
        public void Add(T item)
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x16C84259);
                KernelStream.Write(pointer.ToInt32());
                KernelStream.Write(item);
            }
        }
...
namespace API.System.Runtime
{
    ...
    public class Dispatcher
    {
        ...
        internal Dispatcher(IntPtr pointer)
        {
            this.pointer = pointer;
        }
    
        public List<System.Runtime.Dispatcher.BaseFrame> frames
        {
            get
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x04E740AB);
                    KernelStream.Write(pointer.ToInt32());
                    return KernelStream.Read<List<System.Runtime.Dispatcher.BaseFrame>>();
                }
            }
            set
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x3D5E8B45);
                    KernelStream.Write(pointer.ToInt32());
                    KernelStream.Write<List<System.Runtime.Dispatcher.BaseFrame>>(value);
                }
            }
        }
    
        public void Invoke<Args>(Action<Args> invokation, Args parameters)
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0xBD24D57A);
                KernelStream.Write(pointer.ToInt32());
                KernelStream.Write(invokation);
        ...
        public void Flush()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x41F01243);
                KernelStream.Write(pointer.ToInt32());
            }
        }
    }
    ...
    public class Thread
    {
        ...
        public uint Id
        {
            get
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x59CBDECC);
                    KernelStream.Write(pointer.ToInt32());
                    return KernelStream.ReadUInt32();
                }
            }
        ...
        public string Name
        {
            get
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x58BD7900);
                    KernelStream.Write(pointer.ToInt32());
                    return KernelStream.ReadString();
                }
            }
        }
        public System.Runtime.Process Process
        {
            get
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x9D7A96DD);
                    KernelStream.Write(pointer.ToInt32());
                    return KernelStream.Read<System.Runtime.Process>();
                }
            }
            set
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x6E18BA89);
                    KernelStream.Write(pointer.ToInt32());
                    KernelStream.Write<System.Runtime.Process>(value);
                }
            }
        }
        public System.Runtime.Dispatcher Dispatcher
        {
            get
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x8FB28FD7);
                    KernelStream.Write(pointer.ToInt32());
                    return KernelStream.Read<System.Runtime.Dispatcher>();
                }
            }
            set
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x971736D7);
                    KernelStream.Write(pointer.ToInt32());
                    KernelStream.Write<System.Runtime.Dispatcher>(value);
                }
            }
        }
        public System.Runtime.Thread Current
        {
            get
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x505FD214);
                    KernelStream.Write(pointer.ToInt32());
                    return KernelStream.Read<System.Runtime.Thread>();
                }
            }
            set
            {
                lock (KernelStream.Mutex)
                {
                    KernelStream.Write((uint)0x2BDC3A8B);
                    KernelStream.Write(pointer.ToInt32());
                    KernelStream.Write<System.Runtime.Thread>(value);
                }
            }
        }
    
        public System.Runtime.Process GetProcess()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x2E171A2A);
                KernelStream.Write(pointer.ToInt32());
                return KernelStream.Read<System.Runtime.Process>();
            }
        }
        public System.Runtime.Dispatcher GetDispatcher()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x50E3E813);
                KernelStream.Write(pointer.ToInt32());
                return KernelStream.Read<System.Runtime.Dispatcher>();
            }
        }
        public void SetDispatcher(System.Runtime.Dispatcher value)
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0xABB32B20);
                KernelStream.Write(pointer.ToInt32());
                KernelStream.Write(value);
            }
        }
        public void Start()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x91DC730D);
                KernelStream.Write(pointer.ToInt32());
            }
        }
    }
    ...
    public class Spinlock
    {
        ...
        internal Spinlock(IntPtr pointer)
        {
            this.pointer = pointer;
        }
        ...
        public void Lock()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x95BC273C);
                KernelStream.Write(pointer.ToInt32());
            }
        }
        public void Unlock()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x7691CE22);
                KernelStream.Write(pointer.ToInt32());
            }
        }
    }
    ...
    public class Debugger
    {
        ...
        internal Debugger(IntPtr pointer)
        {
            this.pointer = pointer;
        }
        ...
        public static void Break()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x550FC4B8);
            }
        }
    }
    ...
    public class Profiler
    {
        ...
        internal Profiler(IntPtr pointer)
        {
            this.pointer = pointer;
        }
        ...
        public static void Trace()
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x16389551);
            }
        }
    }
...
namespace API.System.IO
{
    ...
    public class BufferStream
    {
        ...
        public uint Read(IntPtr buffer, uint count)
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0x4210DAAC);
                KernelStream.Write(pointer.ToInt32());
                KernelStream.Write(buffer);
                KernelStream.Write(count);
                return KernelStream.ReadUInt32();
        ...
        public void Write(IntPtr buffer, uint count)
        {
            lock (KernelStream.Mutex)
            {
                KernelStream.Write((uint)0xC1A58484);
                KernelStream.Write(pointer.ToInt32());
                KernelStream.Write(buffer);
                KernelStream.Write(count);
            }
